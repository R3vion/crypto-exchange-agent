...
from src.agent.nodes import query_analyzer_node, rag_node, route_after_rag, route_query
...
def build_graph():
    ...
    graph.add_conditional_edges("query_analyzer", route_query,
        {
            "retrieve": "rag",
    ...
    graph.add_edge("calculator", "evidence_review")
    graph.add_edge("risk_scoring", "evidence_review")
    graph.add_edge("evidence_review", "answer_generator")
