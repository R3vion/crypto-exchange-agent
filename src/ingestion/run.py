...
def main() -> None:
    ...
    print(
        f"Normalized {len(normalized)} valid records."
    )

    inserted = save_regulatory_status(
        normalized,
        source="ESMA MiCA CASP Register",
    )

    print(
        f"Successfully processed {inserted} records."
    )
